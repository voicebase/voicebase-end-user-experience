      ...
      <div className="listing__prediction">
        <Row>
          {predictions.sales_lead &&
            <Col sm={2}>
              <h4 className="listing__prediction__heading">
                Hot Sales<br />Lead
              </h4>
          ...
          {predictions.request_quote &&
            <Col sm={2}>
              <h5 className="listing__prediction__heading">
                Request
                <br />
                for Quote
              </h5>
              <h6 className={this.getClass(predictions.request_quote.value)}>
                {predictions.request_quote.value}
              </h6>
            </Col>
          }
          ...
          {predictions.churn &&
            <Col sm={2}>
              ...
              <h6
                className={this.getClass(predictions.churn.value, 'listing__prediction--churn')}>{predictions.churn.value}%</h6>
            </Col>
          }
